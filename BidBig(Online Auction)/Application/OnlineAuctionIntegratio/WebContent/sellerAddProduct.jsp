        ...
        <div class="container-fluid" >
          ...
          <center> 
            ...
            <div class="form-group">
                ...
                <input type="text" required="required" class="form-control" name="productDescription" >
              </div>
              <div class="form-group">
                <label for="productActualPrice">Actual Price</label>
                <input type="number" required="required" class="form-control" name="productActualPrice" >
              </div>
              <div class="form-group">
                <label for="productQuantity">Quantity</label>
                <input type="number" required="required" class="form-control" name="productQuantity" >
