          ...
          function () {
            ...
            if (timeLeft <= 0) {
              ...
              //and you see "It's over" instead of time left
               ...
               <br>
               <br>
                 <center><a href="createAuction.jsp" type="button" class="btn btn-outline-success">CREATE AUCTION </a></center><br/>
                  <center><a href="sellerAddProduct.jsp" type="button" class="btn btn-outline-success">ADD NEW PRODUCT</a></center><br><br>
                 <div class="container">
                  <div>
                ...
                BidDAOImpl daoImpl2=new BidDAOImpl();
              //username="Shanu";
              ...
              long sellerid=userid;
               System.out.println(sellerid);
      		  ...
      		  List<Bid> bids=new ArrayList<Bid>();
      		   bids=daoImpl2.getAllBidsAuctionedBy(sellerid);
