...
<%@page import="com.hsbc.model.User"%>
...
%>
     ...
     <div class="header">
        ...
        function closeNav() {
          ...
          <a href="buyerProfile.jsp">Hello <%=username %></a>
        
      </div>
      <div class="container">
      <button class="btn"><i class="fa fa-home"> </i> Home</button> 
      <a style="padding-left: 900px;"> Hello, <%=username %></a>
      <br> <br></div><br>
      ...
      <div class="container">
        ...
        <pre style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;text-align: letter-spacing: ;">
       ...
       buyer=daoImpl.getUserDetails(buyerid);
      // System.out.println(buyer);
      out.println();
       out.println("          NAME                : "+buyer.getName());
       out.println("          DATE OF BIRTH  :  "+ buyer.getDateOfBirth());
       out.println("          PHONE               : "+buyer.getPhoneNo());
       out.println("          ADDRESS           : "+buyer.getAddress());
       if(buyer.isUserType())
       out.println("          TYPE                  : buyer");
       else
       out.println("          TYPE                  : seller");
        ...
        <div class="container" >
          ...
          <br><br><br><br>
            ...
            <center><div > 
              ...
              <a href="your_bids.jsp" class="btn btn-outline-secondary" > <img src="https://image.flaticon.com/icons/png/512/120/120069.png" width="64px" height="60px" alt="imghere">
                    &nbsp; &nbsp; Your Bids &nbsp; &nbsp; </a> 
        &nbsp; &nbsp;
           
          
           
              <a href="your_won_bids.jsp" class="btn btn-outline-secondary"> <img src="https://image.flaticon.com/icons/png/512/445/445087.png" width="65px" height="60px" alt="imghere">
                    &nbsp;&nbsp;&nbsp;&nbsp;Bids Won &nbsp; &nbsp;</a> 
           

            <button type="button" class="btn btn-outline-secondary">
              <a > <img src="https://image.flaticon.com/icons/png/512/120/120069.png" width="65px" height="60px" alt="imghere">
                    &nbsp; Available Bids </a> 
            </button> <br> <br>
