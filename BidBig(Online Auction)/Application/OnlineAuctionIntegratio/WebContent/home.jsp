...
<body>
     ...
     <header>
          ...
          <a href="home.jsp" style="font-size: medium;">Home</a>
         
          <a href="registerBuyer.jsp" style="font-size: medium;">Register as Buyer</a>
          <a href="registerSeller.jsp" style="font-size: medium;">Register as Seller</a>
          <a href="loginBuyer.jsp" style="font-size: medium;">Login as Buyer</a>
          <a href="loginSeller.jsp" style="font-size: medium;">Login as Seller</a>
        ...
        <span1 style=" position:absolute; top:0;left:0; font-size:25px;cursor:pointer" onclick="openNav()">&#9776;</span1>
              ...
              <br><br>
                ...
                <div style="position: absolute; top: 0; right: 0; width: 100px; text-align:right;">
                 <a  href="loginBuyer.jsp"><strong> Login/Signup </strong></a>
                </div>
            	         ...
            	         <div class="card" style="width: 18rem;">
            	           ...
            	           <div class="card-body">
            	             ...
            	             <p class="card-text">BID STATUS : <%=bidstatus %></p>
            	              <p class="card-text">YOUR BID STATUS :<%=bidstatus %></p>
            	               <p class="card-text">MAX BID VALUE : <%=maxvalue %></p>
            	                <p class="card-text">BASE BID VALUE : <%=minvalue %></p>
            	               <div><center><a href="loginBuyer.jsp" class="btn btn-primary" style="height:45px">BID NOW</a></div></center>
...
<form  action="registerbuyer.jsp" method="post">
